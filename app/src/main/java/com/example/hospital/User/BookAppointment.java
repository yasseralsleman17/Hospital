...
public class BookAppointment extends AppCompatActivity {
    ...
    String doctor = "", clinic = "Pulmonary";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ArrayAdapter<String> time_spinner_adapter = new ArrayAdapter<>(BookAppointment.this, android.R.layout.simple_spinner_dropdown_item, time_items);
